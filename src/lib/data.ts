...
export const serviceTiers: ServiceTier[] = [
  {
    ...
    features: ["Curated creator shortlist", "Warm introductions", "Campaign fit notes"],
    savingsRate: 0.12,
    accent: "lime",
  },
  {
    ...
    eyebrow: "02 / flagship",
    scope: "Matching, contracting, studio filming, editing, and end-to-end campaign delivery.",
    offer: "15% Off 3-Month Retainer + Free Video Editing Upgrade",
    features: ["Talent and contract management", "In-house studio production", "Edit, delivery, and reporting"],
    savingsRate: 0.27,
    accent: "purple",
  },
  {
    ...
    features: ["One custom campaign brief", "Creator pairing and production", "Tier 2 upgrade credit"],
    savingsRate: 0.1,
    accent: "lime",
  },
];
